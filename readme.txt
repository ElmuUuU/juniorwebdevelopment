...
we decided to make a lives system - a way to track how many mistakes the player has made and to make the run fail, when he accumulates too many mistakes.
...
The logcic we implemented for every game:
...
-  For the individual games we also ran into some severe problems. Most importantly React Hydration errors. 
